...
export const benefitsData = [
    {
        ...
        description: "Easily manage your clients with a streamlined dashboard, giving you full control over client information and interactions."
    },
    {
        title: "Direct Loan Applications",
        description: "Enable customers to apply for loans directly through the platform, simplifying the process for both lenders and borrowers."
    },
    {
    ...
    },
    {
        ...
        description: "Allow users to securely upload important documents like ID, bank statements, and payslips, with encrypted storage and easy access."
    },
    {
